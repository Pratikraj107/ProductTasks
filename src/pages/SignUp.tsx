...
export default function SignUp({ onNavigate }: SignUpProps) {
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-slate-950 text-white overflow-x-hidden relative flex items-center justify-center px-4">
        ...
        <div className="max-w-sm w-full relative z-10">
          <div className="relative">
            <div className="absolute -inset-1 bg-gradient-to-br from-green-600 to-emerald-600 rounded-3xl blur opacity-20"></div>
            <div className="relative bg-slate-900/80 backdrop-blur-xl rounded-3xl p-6 border border-slate-800 text-center">
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white overflow-x-hidden relative flex items-center justify-center px-4">
      ...
      <div className="max-w-sm w-full relative z-10">
        ...
        <div className="relative">
          <div className="absolute -inset-1 bg-gradient-to-br from-blue-600 to-cyan-600 rounded-3xl blur opacity-20"></div>
